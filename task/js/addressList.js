...
// type 0:通讯录 1:单选（抄送人） 2:多选（派工） 3:单选（出库人） 4:单选 获取通讯录列表(本部门客户代表)  5.介绍员工
...
function service_recently_list(vueObj) {
    ...
    $.ajax({
        url:BASE_URL + "service_recently_list",
        type:"POST",
        data: obj,
        timeout:1000*10,
        dataType:"json",
...
function introduce_person_list(vueObj) {
    ...
    $.ajax({
        url:BASE_URL + "introduce_person_list",
        type:"POST",
        data: obj,
        timeout:1000*10,
        dataType:"json",
...
function get_organize_name(vueObj) {
    ...
    $.ajax({
        url:BASE_URL + "get_organize_name",
        type:"POST",
        data: obj,
        timeout:1000*10,
        dataType:"json",
